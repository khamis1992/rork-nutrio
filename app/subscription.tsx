...
export default function SubscriptionScreen() {
  ...
  const { plans, subscribe, fetchPlans, isLoading: storeLoading, error: storeError } = useSubscriptionStore();
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      const errorMessage = error?.message || error?.error_description || error?.details || "Failed to subscribe. Please try again.";
      Alert.alert(
        "Subscription Failed", 
        errorMessage
      );
